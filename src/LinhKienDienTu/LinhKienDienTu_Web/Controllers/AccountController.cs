    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ForgotPassword(string email)
        {
            ...
            var message = $"<p>Chào {user.Ho_Ten},</p>" +
                          $"<p>Bạn vừa yêu cầu khôi phục mật khẩu tài khoản TopGearVN - Gaming Gear Pro Shop.</p>" +
            ...
            {
                // Gửi email
                await _emailSender.SendEmailAsync(user.Email, "Khôi phục mật khẩu TopGearVN - Gaming Gear Pro Shop", message);
